...
ALTER FUNCTION public.check_receita_safety(UUID) SET search_path = public, pg_temp;
ALTER FUNCTION public.check_clinical_alerts(UUID, UUID) SET search_path = public, pg_temp;
